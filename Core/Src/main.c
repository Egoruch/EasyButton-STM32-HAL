...
/* Definitions for AdcCalc */
osThreadId_t AdcCalcHandle;
const osThreadAttr_t AdcCalc_attributes = {
  .name = "AdcCalc",
  .stack_size = 512 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
/* Definitions for Handler1ms */
osThreadId_t Handler1msHandle;
const osThreadAttr_t Handler1ms_attributes = {
  .name = "Handler1ms",
  .stack_size = 128 * 4,
...
/* USER CODE BEGIN Header_StartAdcCalc */
/**
* @brief Function implementing the AdcCalc thread.
* @param argument: Not used
* @retval None
*/
...
void StartAdcCalc(void *argument)
{
  ...
  /* USER CODE END StartAdcCalc */
}

/* USER CODE BEGIN Header_StartHandler1ms */
/**
* @brief Function implementing the Handler1ms thread.
* @param argument: Not used
* @retval None
*/
